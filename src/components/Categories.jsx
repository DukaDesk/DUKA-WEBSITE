...
export function Categories() {
  const cats = [
    ...
    { id: "food-vendor", name: "Food Vendor",desc: "Take orders, manage deliveries, and grow your catering business.",           color: "#F0FDF4", accent: "#2ECC71" },
    ...
    { id: "any-business", name: "Any Business",desc: "Fully custom — your rules, your brand, your way of doing business.",   color: `${NAVY}08`, accent: NAVY },
  ];
    ...
    <section id="categories" data-pad="wide" style={{ padding: "100px 80px", background: CREAM }}>
      <FadeIn>
        <div style={{ textAlign: "center", marginBottom: 64 }}>
          ...
          <h2 data-type="h2" style={{ fontFamily: sora, fontWeight: 800, fontSize: 48, color: NAVY, marginBottom: 16 }}>Solutions for every business</h2>
          <p style={{ fontSize: 17, color: LGREY, maxWidth: 500, margin: "0 auto" }}>Whether you run a restaurant, store, salon, or church — DukaDesk is built for the way you do business.</p>
        </div>
      </FadeIn>
        ...
        {cats.map((c, i) => {
          ...
          <FadeIn key={i} delay={i * 60}>
            <Tilt max={6}>
              ...
              >
                <div style={{ width: 48, height: 48, background: `${c.accent}18`, borderRadius: 14, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 14 }}>
