...
export function Categories() {
  const cats = [
    ...
    { id: "any-business", name: "Any Desk",desc: "Fully custom — your rules, your brand, your way of running a desk.",   color: `${NAVY}08`, accent: NAVY },
  ];
    ...
    <section id="categories" data-pad="wide" style={{ padding: "100px 80px", background: CREAM }}>
      <FadeIn>
        <div style={{ textAlign: "center", marginBottom: 64 }}>
          ...
          <h2 data-type="h2" style={{ fontFamily: sora, fontWeight: 800, fontSize: 48, color: NAVY, marginBottom: 16 }}>Solutions for every desk</h2>
