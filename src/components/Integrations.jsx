...
export function Integrations() {
  ...
  return (
    <section style={{ padding: "100px 80px", background: NAVY, overflow: "hidden" }}>
      <FadeIn>
        <div style={{ textAlign: "center", marginBottom: 64 }}>
          ...
          <h2 style={{ fontFamily: sora, fontWeight: 800, fontSize: 48, color: "white", marginBottom: 16 }}>Add what you need.<br /><span style={{ color: AMBER }}>Leave out what you don't.</span></h2>
